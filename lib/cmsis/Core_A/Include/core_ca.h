...
#define section_normal_rw(descriptor_l1, region) region.rg_t = SECTION; \
                                   ...
                                   region.sh_t = NON_SHARED; \
                                   MMU_GetSectionDescriptor(&descriptor_l1, region);
//Sect_Normal_RW_NonCache. Sect_Normal_Cod, but writeable and not executable
...
//Page_4k_Normal non-shareable, executable rw
...
//Page_4k_Normal_NC_RW non-cacheable non-shareable, non-executable rw
#define page4k_normal_nc_rw(descriptor_l1, descriptor_l2, region) region.rg_t = PAGE_4k; \
                                   region.domain = 0x0; \
                                   region.e_t = ECC_DISABLED; \
                                   region.g_t = GLOBAL; \
                                   region.inner_norm_t = NON_CACHEABLE; \
