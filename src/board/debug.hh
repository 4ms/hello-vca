...
struct Debug {
	...
	using Pin0 = mdrivlib::FPin<mdrivlib::GPIO::B, 8, mdrivlib::PinMode::Output>; // Third pin

	using Pin1 = mdrivlib::FPin<mdrivlib::GPIO::F, 4, mdrivlib::PinMode::Output>; // Fourth pin (FREEZE)
	using Pin2 = mdrivlib::FPin<mdrivlib::GPIO::B, 3, mdrivlib::PinMode::Output>; // Uart RX

	using Pin3 = mdrivlib::FPin<mdrivlib::GPIO::G, 11, mdrivlib::PinMode::Output>; // Across from RX
	using Pin4 = mdrivlib::FPin<mdrivlib::GPIO::G, 3, mdrivlib::PinMode::Output>;  // Across from Pin0
